...
## ขั้นตอนการตั้งค่า Autoregistration

ไปที่เครื่องที่ต้องการทำ Autoregistration จากนั้นแก้ไขไฟล์ `zabbix_agent2.conf` (หรือ zabbix_agentd.conf)
...
> [!NOTE]
>
> หลังจากทำการแก้ไขการตั้งค่าเรียบร้อย ควรรีสตาร์ท Zabbix agent เพื่ออัปเดตการตั้งค่าใหม่

## ตั้งค่า Autoregistration Action บน Zabbix Server

1.  ไปที่เมนู Alerts > Actions > Autoregistration actions

    ![auto-registration-1](/assets/zabbix/auto-registration-1.png)

2.  คลิกปุ่ม Create action

    ![auto-registration-2](/assets/zabbix/auto-registration-2.png)

**แท็บ Action**

- Name: ตั้งชื่อ action เช่น Autoregistration. Zabbix servers

  ![auto-registration-3](/assets/zabbix/auto-registration-3.png)
...
- Conditions: เพิ่มเงื่อนไข เช่น
  ...
  - Value: ระบุค่า `HostMetadata` ให้ตรงกันกับที่ตั้งค่าไว้ใน Agent
    ...
    ![auto-registration-4](/assets/zabbix/auto-registration-4.png)

**แท็บ Operations**

- คลิกปุ่ม Add ใต้ส่วน Operations

  ![auto-registration-6](/assets/zabbix/auto-registration-6.png)
...
- ที่ช่อง Operation type ให้เลือกสิ่งที่ต้องการให้ Zabbix ทำ เช่น:
  ...
  - Link to template – ผูกเครื่องเข้ากับเทมเพลตที่ใช้ในการมอนิเตอร์
    ...
    ![auto-registration-7](/assets/zabbix/auto-registration-7.png)

> [!TIP]
>
> สามารถเพิ่มเงื่อนไข Operations ได้มากกว่า 1 เงื่อนไข

ตัวอย่าง:

![auto-registration-8](/assets/zabbix/auto-registration-8.png)
...
![auto-registration-5](/assets/zabbix/auto-registration-5.png)

> [!NOTE]
>
> การเพิ่มเงื่อนไขนี้จะช่วยให้ Action ทำงานเฉพาะกับ Agent ที่เชื่อมต่อผ่าน Proxy ที่ระบุไว้เท่านั้น
